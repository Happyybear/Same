...
- (void)pushToNewViewController:(UIViewController *)viewController animation:(BOOL)animation {
    [self showRootViewController:YES];
    [(MyNavigationController *)_rootViewController pushViewController:viewController animated:animation];
}
...
-(void)setNavigationBackButton{
    if (_rootViewController) {
        ...
        if ([_rootViewController isKindOfClass:[MyNavigationController class]]) {
            
            MyNavigationController *navController = (MyNavigationController*)_rootViewController;
