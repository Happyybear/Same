...
@interface ArchieveTreeTableView ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation ArchieveTreeTableView
...
-(instancetype)initWithFrame:(CGRect)frame withData : (NSArray *)data{
    ...
    if (self) {
        ...
        ima.image = [UIImage imageNamed:@"PayBG.jpg"];
...
- (void)refreshTree:(NSMutableArray *)m_data
{
    ...
    _tempData = [self createTempData:m_data];
    [self reloadData];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    ArchieveTreeCell *cell = [tableView dequeueReusableCellWithIdentifier:NODE_CELL_ID];
    cell = [[ArchieveTreeCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:NODE_CELL_ID];
