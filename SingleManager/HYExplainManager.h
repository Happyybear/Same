...
//解析加密
- (int)TSR376_Anlysis_OrderInfo:(unsigned char *)in_bufer bufer_len:(int)bufer_len iEnd:(int*)iEnd;
//上传支付完成订单
...
// ------短信欠费提醒
- (int)TSR376_GetACK_SendMessageFame:(NSString *)m_Inaddr Company_ID:(NSString *)Company_ID Usr_check_ID:(UInt64)Usr_checkID User_ID:(NSString *)userID device_ID:(NSString *)device_ID messageLen:(int)len message:(NSString *)message  andTel:(NSString*)tel OutBufData:(unsigned char *)OutBufData;
#pragma mark - **************** 控制终端
/**
 *pc段方法
 *
