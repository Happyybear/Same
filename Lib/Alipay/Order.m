...
- (NSString*)encodeValue:(NSString*)value
{
    ...
    if (value.length > 0) {
        encodedValue = (__bridge_transfer  NSString*)CFURLCreateStringByAddingPercentEscapes(kCFAllocatorDefault, (__bridge CFStringRef)value, NULL, (__bridge CFStringRef)@"!*'();:@&=+$,/?%#[]_", kCFStringEncodingUTF8 );
    }
    return encodedValue;
}
